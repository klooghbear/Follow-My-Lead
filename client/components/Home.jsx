        ...
        <main>
          ...
          <div className="hero-image">
            ...
            <div className="register-buttons">
              <Link className="button" to="/Register/Owner">
                Register to have your dog walked
              </Link>
              
              <Link className="button" to="/Register/Walker">
          ...
          <div className="blurb-container">
            ...
            <div className="blurb-text">
              ...
              dogs! We are working together to improve our development skills
              by creating a platform for dog lovers that can't own dogs and dog
              owners that don't always have the time to walk them.
            </div>
          </div>
